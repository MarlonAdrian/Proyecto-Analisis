...
Se utilizó la herramienta de Jupyter, y que esta esté basada por el lenguaje de programación de python. Al momento que recopile los datos se extraerán como csv y con data por limpiar. 
Después, con RapidMiner se limpiará filas y columnas con valores nulos, mediante un filtro y elimnando manualmente las columnas innecesarias, para que luego tenga una salida la data como *xlsx* y *csv*. 
